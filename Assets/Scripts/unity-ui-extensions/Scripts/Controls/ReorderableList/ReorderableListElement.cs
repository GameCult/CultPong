...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ReorderableListElement : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            //Can't drag, return...
            if (!_reorderableList.IsDraggable || !IsDraggable)
            {
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            else
            {
                ...
                int targetIndex = 0;
                float dist = 0;
                for (int j = _currentReorderableListRaycasted.IgnoreFirst?1:0; j < _currentReorderableListRaycasted.Content.childCount; j++)
                {
